...
Java_com_superpowered_effect_Preview_NativeInit(JNIEnv *env, jobject __unused obj, jint samplerate, jint buffersize, jstring tempPath) {
...
extern "C" JNIEXPORT void
Java_com_superpowered_effect_Preview_OpenFileFromAPK (
        JNIEnv *env,
...
Java_com_superpowered_effect_Preview_onUserInterfaceUpdate(JNIEnv * __unused env, jobject __unused obj) {
...
extern "C" JNIEXPORT void
Java_com_superpowered_effect_Preview_TogglePlayback(JNIEnv * __unused env, jobject __unused obj) {
...
extern "C" JNIEXPORT void
Java_com_superpowered_effect_Preview_onBackground(JNIEnv * __unused env, jobject __unused obj) {
    audioIO->onBackground();
}

// onForeground - Resume audio processing.
extern "C" JNIEXPORT void
Java_com_superpowered_effect_Preview_onForeground(JNIEnv * __unused env, jobject __unused obj) {
    audioIO->onForeground();
}

// Cleanup - Free resources.
extern "C" JNIEXPORT void
Java_com_superpowered_effect_Preview_Cleanup(JNIEnv * __unused env, jobject __unused obj) {
    delete audioIO;
    delete player;
}

// getPositionMs - get current position for player
extern "C" JNIEXPORT double
Java_com_superpowered_effect_Preview_getCurrentPosition(JNIEnv * __unused env, jobject __unused obj) {
    return  player->getPositionMs();
}

// getPositionMs - get current position for player
extern "C" JNIEXPORT void
Java_com_superpowered_effect_Preview_seekTo(JNIEnv * __unused env, jobject __unused obj,jdouble position ) {
      player->setPosition(position, true, false, false);
}
